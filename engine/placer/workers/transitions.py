...
from .. import calls
from .common import clear_barriers, get_case, get_payload, notify, short_ref, telephony_waiting
...
def book_transport(session: Session, task, ehr, worker: str) -> dict:
    ...
    Without telephony the task parks as waiting — no booking is invented."""
